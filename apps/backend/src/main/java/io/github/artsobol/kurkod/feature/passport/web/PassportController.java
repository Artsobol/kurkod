...
public class PassportController {
  ...
  @GetMapping
  public ResponseEntity<PassportResponse> get(@PathVariable(name = "workerId") Long id) {
  ...
  public ResponseEntity<PassportResponse> create(
      @PathVariable(name = "workerId") Long id, @RequestBody @Valid PassportCreateRequest request) {
