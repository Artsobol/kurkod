...
public class RowsController {
  ...
  public ResponseEntity<RowsResponse> get(
      @PathVariable Long workshopId, @PathVariable(name = "rowNumber") Integer rowsNumber) {
  ...
  public ResponseEntity<List<RowsResponse>> getAll(@PathVariable Long workshopId) {
