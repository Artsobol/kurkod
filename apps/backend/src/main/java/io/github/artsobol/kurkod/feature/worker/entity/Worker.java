...
public class Worker extends AbstractEntity {
  ...
  @Size(max = 30, message = "First name should be between 1 and 50 characters") private String firstName;

  @NotBlank @Column(nullable = false, length = 30)
  @Size(max = 30, message = "Last name should be between 1 and 50 characters") private String lastName;

  @Column(length = 30)
  @Size(max = 30, message = "Patronymic should be less than 30 characters") private String patronymic;
