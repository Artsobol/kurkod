...
public class DirectorReportController {
  ...
  public ResponseEntity<List<ChickensByWorkshopAndBreedResponse>> getChickensByWorkshopAndBreed() {
    ...
    List<ChickensByWorkshopAndBreedResponse> response =
        chickenReportService.getChickensByWorkshopAndBreed();
    return ResponseEntity.ok(response);
  }
  ...
  public ResponseEntity<List<ChickenEggStatsResponse>> getChickenEggStats(
    ...
    List<ChickenEggStatsResponse> response =
        chickenReportService.getEggStats(weight, breedId, birthDate);
    return ResponseEntity.ok(response);
  }
  ...
  public ResponseEntity<List<WorkerReportDailyEggsResponse>> getWorkerDailyEggs(
    ...
    List<WorkerReportDailyEggsResponse> response =
        workerReportService.getWorkerDailyEggs(year, month);
    return ResponseEntity.ok(response);
  }
}
